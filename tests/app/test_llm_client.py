...
class TestLLMClient:
    ...
    def test_generate_text_no_keys(self):
        """Test generate_text raises error when no keys are available."""
        with httpx.Client() as http_client:
            llm_client = LLMClient(http_client)
    ...
    def test_generate_text_openai_success(self):
    ...
    def test_generate_text_anthropic_success(self):
    ...
    def test_generate_text_http_error(self):
        """Test generate_text handles HTTP errors properly."""
        with httpx.Client() as http_client:
            llm_client = LLMClient(http_client, openai_api_key="test-key")
    ...
    def test_generate_text_timeout_error(self):
        """Test generate_text handles timeout errors properly."""
        with httpx.Client() as http_client:
            llm_client = LLMClient(http_client, openai_api_key="test-key")
    ...
    def test_generate_text_openrouter_success(self):
